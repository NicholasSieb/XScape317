...
public class PlayerAssistant{
	...
	**/
	...
	public void handleLoginText() {	
		...
		c.getPA().sendFrame126("Other (2)", 7457);
		c.getPA().sendFrame126("Other (3)", 13097);
		c.getPA().sendFrame126("Other(4)", 13089);
