...
public class ObjectManager {
	...
	public void loadCustomSpawns(Client c) {
		c.getPA().checkObjectSpawn(3192, 3086, 3485, 0, 10);
		...
		c.getPA().checkObjectSpawn(2091, 2865, 9953, 1, 10);
		...
		c.getPA().checkObjectSpawn(2095, 2867, 9952, 1, 10);
		c.getPA().checkObjectSpawn(2105, 2860, 9953, 1, 10);
		c.getPA().checkObjectSpawn(2105, 2860, 9954, 1, 10);
		c.getPA().checkObjectSpawn(2107, 3043, 9785, 1, 10);
		c.getPA().checkObjectSpawn(2107, 3044, 9785, 1, 10);
		c.getPA().checkObjectSpawn(4551, 2522, 3595, 1, 10);
		c.getPA().checkObjectSpawn(2103, 2871, 9950, 1, 10);
		c.getPA().checkObjectSpawn(2103, 2871, 9951, 1, 10);
		c.getPA().checkObjectSpawn(2093, 2869, 9952, 1, 10);
		c.getPA().checkObjectSpawn(2093, 2862, 9952, 1, 10);
			c.getPA().checkObjectSpawn(409, 3087, 3504, 1, 10);
		if (c.heightLevel == 0)
