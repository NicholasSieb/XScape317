...
public class Config {
	...
	public static final String SERVER_NAME = "X-Scape 317";
	public static final String WELCOME_MESSAGE = "visit xscapeserver.tk";
	public static final String FORUMS = "www.xscapeserver.tk";
	...
	public static final int MELEE_EXP_RATE = 4000; // damage * exp rate
	public static final int RANGE_EXP_RATE = 4000;
	public static final int MAGIC_EXP_RATE = 4000;
	...
	*/	
	public static final int WOODCUTTING_EXPERIENCE = 200;
	public static final int MINING_EXPERIENCE = 200;
	public static final int SMITHING_EXPERIENCE = 200;
	public static final int FARMING_EXPERIENCE = 200;
	public static final int FIREMAKING_EXPERIENCE = 40;
	public static final int HERBLORE_EXPERIENCE = 200;
	public static final int FISHING_EXPERIENCE = 200;
	public static final int AGILITY_EXPERIENCE = 400;
	public static final int PRAYER_EXPERIENCE = 999;
	public static final int RUNECRAFTING_EXPERIENCE = 200;
	public static final int CRAFTING_EXPERIENCE = 200;
	public static final int THIEVING_EXPERIENCE = 200;
	public static final int SLAYER_EXPERIENCE = 85;
	public static final int COOKING_EXPERIENCE = 200;
	public static final int FLETCHING_EXPERIENCE = 85;
}
